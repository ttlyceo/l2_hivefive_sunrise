...
public final class MobGroup
{
	...
	{
		spawnGroup(x, y, z, 0, Rnd.nextInt(MobGroupTable.RANDOM_RANGE), Rnd.nextInt(MobGroupTable.RANDOM_RANGE));
	}
	
	public void spawnGroup(int x, int y, int z, int idInstance)
	{
		spawnGroup(x, y, z, idInstance, Rnd.nextInt(MobGroupTable.RANDOM_RANGE), Rnd.nextInt(MobGroupTable.RANDOM_RANGE));
	}
	
	public void spawnGroup(int x, int y, int z, int idInstance, int RangeX, int RangeY)
	{
		...
		try
		{
			for (int i = 0; i < getMaxMobCount(); i++)
			{
				...
				spawn.setInstanceId(idInstance);
	...
	{
		spawnGroup(activeChar.getX(), activeChar.getY(), activeChar.getZ(), activeChar.getInstanceId());
	}
