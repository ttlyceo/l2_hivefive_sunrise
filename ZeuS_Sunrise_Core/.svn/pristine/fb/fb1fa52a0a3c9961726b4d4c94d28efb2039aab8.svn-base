...
public class RecipeShopSellList extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		{
			if (ZeuS.isPremium(_manufacturer, true, _buyer))
			{
				_buyer.sendMessage("The Player " + _manufacturer.getName() + " has a Premium System (Name: " + ZeuS.getPremiumName(_manufacturer) + ") , and you will get " + String.valueOf(ZeuS.getPremiumCraftChance(_manufacturer) + "% more over the Craft Chance and " + String.valueOf(ZeuS.getPremium_MW_CraftChance(_manufacturer)) + "% over on Masterwork (rare) Chance."));
