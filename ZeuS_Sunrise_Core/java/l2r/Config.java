...
public final class Config extends AbstractConfigs
{
	...
	public void loadConfigs()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			WELCOME_MESSAGE_TEXT = L2JModSettings.getString("ScreenWelcomeMessageText", "歡迎進入靈姬天堂II!");
			...
			ANNOUNCE_PK_MSG = L2JModSettings.getString("AnnouncePkMsg", "$killer 殘忍地殺害了 $target");
			ANNOUNCE_PVP_MSG = L2JModSettings.getString("AnnouncePvpMsg", "$killer 擊敗了 $target");
