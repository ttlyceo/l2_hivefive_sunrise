			...
			switch (subCommand)
			{
				case "tradeprot":
					if (activeChar.getVarB("noTrade"))
					{
						...
						activeChar.sendMessage("交易拒絕模式已停用。");
					}
					else
					{
						activeChar.setVar("noTrade", "true");
						activeChar.sendMessage("拒絕交易模式已啟用。");
					}
					break;
				case "changeexp":
					if (CustomServerConfigs.ALLOW_EXP_GAIN_COMMAND)
					{
						if (!activeChar.getVarB("noExp"))
						{
							...
							activeChar.sendMessage("經驗值獲取已啟用。");
						}
						else
						{
							activeChar.setVar("noExp", "false");
							activeChar.sendMessage("經驗值獲取已停用。");
						}
					}
					else
					{
						activeChar.sendMessage("經驗值指令已被GM禁用。");
					}
					break;
				case "nobuff":
					if (activeChar.getVarB("noBuff"))
					{
						...
						activeChar.sendMessage("異常保護已停用。");
					}
					else
					{
						activeChar.setVar("noBuff", "true");
						activeChar.sendMessage("異常效果保護已啟用。");
					}
					break;
				case "enchantanime":
					if (activeChar.getVarB("showEnchantAnime"))
					{
						...
						activeChar.sendMessage("強化動畫已停用。");
					}
					else
					{
						activeChar.setVar("showEnchantAnime", "true");
						activeChar.sendMessage("強化動畫已啟用。");
					}
					break;
				case "hidestores":
					if (activeChar.getVarB("hideStores"))
					{
						...
						activeChar.sendMessage("所有商店已顯示，請重新啟動。");
					}
					else
					{
						activeChar.setVar("hideStores", "true");
						activeChar.sendMessage("所有商店已隱形，請重新啟動。");
					}
					break;
				case "shotsonenter":
					if (activeChar.getVarB("onEnterLoadSS"))
					{
						...
						activeChar.sendMessage("進入時自動裝填箭矢功能已關閉。");
					}
					else
					{
						activeChar.setVar("onEnterLoadSS", "true");
						activeChar.sendMessage("進入時自動裝填箭矢已啟用。");
					}
					break;
				case "blockshotsanime":
					if (!activeChar.getVarB("hideSSAnime"))
					{
						...
						activeChar.sendMessage("啟用廣播射擊動畫。");
					}
					else
					{
						activeChar.setVar("hideSSAnime", "false");
						activeChar.sendMessage("廣播射擊動畫已禁用。");
					}
					break;
			}
