...
public abstract class AbstractScript implements INamable
{
	...
	public static L2Npc addSpawn(int npcId, int x, int y, int z, int heading, boolean randomOffset, long despawnDelay, boolean isSummonSpawn, int instanceId, boolean isNoWalk)
	{
		L2Npc npc = addSpawn(null, npcId, x, y, z, heading, randomOffset, despawnDelay, isSummonSpawn, instanceId);
		if(isNoWalk){
