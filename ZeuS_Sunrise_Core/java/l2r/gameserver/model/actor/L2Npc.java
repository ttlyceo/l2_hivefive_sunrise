...
//				}
	...
	public boolean doDie(L2Character killer)
	{
		if (killer != null && killer.isPlayer())
		{
			...
			if (pk.getLevel() >= 40)
			{
				if (!(opera.haveItem(pk, 39995)) &&
					!(opera.haveItem(pk, 39996)) &&
					!(opera.haveItem(pk, 39997)) &&
					!(opera.haveItem(pk, 39998)) &&
					!(opera.haveItem(pk, 39999)))
				{
	...
	public void sendInfo(L2PcInstance activeChar)
	{
		if (isVisibleFor(activeChar))
		{
			...
			{
				activeChar.sendMessage("新增NPC:" + getName());
			}
