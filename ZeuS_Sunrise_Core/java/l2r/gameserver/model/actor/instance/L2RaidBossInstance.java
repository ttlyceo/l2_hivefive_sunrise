...
public class L2RaidBossInstance extends L2MonsterInstance
{
	...
	{
		setIsNoRndWalk(true);
		v_RaidBossInfo.setStatusToRB(getId(), true, "0");
		super.onSpawn();
	}
	...
	public boolean doDie(L2Character killer)
	{
		...
		if (player != null)
		{
			...
			{
				Broadcast.toAllOnlinePlayers("RaidBoss 管理員:" + getName() + "已擊敗！", true);
			}
		...
		v_RaidBossInfo.setStatusToRB(getId(), false, String.valueOf(System.currentTimeMillis()));
		return true;
	}
