...
public class L2RaidBossZone extends L2RespawnZone
{
	...
	protected void onEnter(L2Character character)
	{
		 ...
		 * !activeChar.isGM()) { activeChar.teleToLocation(-248372, 250444, 4344, 200); activeChar.sendMessage("您已經在裡面有一個角色了。"); RemovePlayerInside(activeChar); return; } if !activeChar.isGM()) { addPlayerInside(activeChar); } }
		 */
	}
