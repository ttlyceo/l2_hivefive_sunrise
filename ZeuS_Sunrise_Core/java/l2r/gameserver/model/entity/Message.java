...
public class Message
{
	...
	private static final Logger _log = Logger.getLogger(Message.class.getName());
	private static int EXPIRATION = 360; // 15 days
	...
	public Message(int senderId, int receiverId, boolean isCod, String subject, String text, long reqAdena, int days)
	{
		long newData = new Long( (days * 86400l) * 1000l );
		long Expi = System.currentTimeMillis() + newData;
