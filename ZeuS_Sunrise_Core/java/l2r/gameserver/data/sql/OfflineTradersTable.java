							...
							switch (type)
							{
								case BUY:
									while (items.next())
									{
										...
										ZeuS.setNewAuctionFromServer(player, items.getInt(2) , items.getLong(3), items.getLong(4), false, 0);
									}
								...
								case PACKAGE_SELL:
									while (items.next())
									{
										...
										ZeuS.setNewAuctionFromServer(player, items.getInt(2) , items.getLong(3), items.getLong(4), true, 0);										
									}
