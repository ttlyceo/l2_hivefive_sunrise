...
public class L2GameClient extends MMOClient<MMOConnection<L2GameClient>>
{
	...
	public L2GameClient(MMOConnection<L2GameClient> con)
	{
		...
		_crypt = JGuard.isProtectEnabled() ? new JGameCrypt() : new GameCrypt();
	...
	{
		return getRealIpAddress() != null && !getRealIpAddress().isEmpty() ? getRealIpAddress() : getConnectionAddress().getHostAddress();
	}

	public String getDefaultAddress()
	{
		final String defaultAddress = getConnectionAddress().getHostAddress();
