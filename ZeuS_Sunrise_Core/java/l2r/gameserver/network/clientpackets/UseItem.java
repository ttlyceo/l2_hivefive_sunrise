...
public final class UseItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (item.isEquipable())
		{
			...
			{
				activeChar.sendMessage("您將因使用過度強化的物品而被踢出！");
	...
	private void reuseData(L2PcInstance activeChar, L2ItemInstance item, long remainingTime)
	{
		...
		if(autoPots.isAutoMp(activeChar, item, null) || autoPots.isAutoCp(activeChar, item, null) || autoPots.isAutoHp(activeChar, item, null) ) {
			return;
		}
		if (hours > 0)
		{
