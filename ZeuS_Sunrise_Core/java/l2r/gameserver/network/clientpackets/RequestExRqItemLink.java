...
import l2r.gameserver.model.events.impl.character.player.OnPhantomPlayerQuestionMarkClicked;
...
public class RequestExRqItemLink extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (client != null)
		{
			...
			}else if(object instanceof PhantomPlayer){
                EventDispatcher.getInstance().notifyEventAsync(new OnPhantomPlayerQuestionMarkClicked(client.getActiveChar(), _objectId), client.getActiveChar());
            }
			else
			{
				try
