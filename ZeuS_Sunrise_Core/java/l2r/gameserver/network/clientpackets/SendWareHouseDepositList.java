...
public final class SendWareHouseDepositList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (((manager == null) || (!manager.isWarehouse() && !ZeuS.isNpcFromZeus(manager.getId())) || !manager.canInteract(player)) && !player.isGM() && !player.isUsingAioWh())
		{
			return;
		}
		...
		{
			player.sendMessage("您的存取等級已停用交易功能。");
			return;
		}
