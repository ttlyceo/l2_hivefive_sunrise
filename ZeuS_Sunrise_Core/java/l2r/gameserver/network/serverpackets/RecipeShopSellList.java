...
public class RecipeShopSellList extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		else
		{
			...
			{
				_buyer.sendMessage("玩家" + _manufacturer.getName() + "擁有一個高級系統 (名稱:" + ZeuS.getPremiumName(_manufacturer) + ")，並且你將會獲得" + String.valueOf(ZeuS.getPremiumCraftChance(_manufacturer) + "% 更多關於製作機率和" + String.valueOf(ZeuS.getPremium_MW_CraftChance(_manufacturer)) + "% 超過大師級（稀有）機率。"));
