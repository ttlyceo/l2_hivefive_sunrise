...
//		sysm.addInt(seconds);
	...
	public void telnetAbort(String IP)
	{
		...
		{
			_counterInstance._abort();
			Broadcast.toAllOnlinePlayers("伺服器已中止 " + MODE_TEXT[_shutdownMode] + " 模式，並恢復正常運作！", false);
		}
	}
	...
	public void abort(L2PcInstance activeChar)
	{
		...
		{
			_counterInstance._abort();
			Broadcast.toAllOnlinePlayers("伺服器已中止 " + MODE_TEXT[_shutdownMode] + "，並恢復正常運作！", false);
		}
	}
