...
public class FortressReward extends AbstractNpcAI
{
	...
	private static final int[] ARCHER_DROP    = { 10, 20, 100 };
	...
	private static final int[] CGUARD_DROP    = { 10, 20, 100 };
	...
	private static final int[] DECORATED_DROP = { 10, 20, 100 };
	...
	private static final int[] DGSERG_DROP2   = { 10, 20, 100 };
	...
	private static final int[] GUARD_DROP     = { 10, 20, 100 };
	...
	private static final int[] HEALER_DROP    = { 10, 20, 100 };
	...
	private static final int[] WIZARD_DROP    = { 10, 20, 100 };
	// @formatter:on
	...
	private void rewardPlayer(L2PcInstance player, L2Npc npc, int[] drop)
	{
		if (getRandom(100) < (drop[2] - (player.getLevel() - npc.getLevel())))
		{
			...
			int rate = (int) ( Config.ZEUS_FORTRESS_EPAULETTE_RATE == -1 ? Config.RATE_DROP_ITEMS : Config.ZEUS_FORTRESS_EPAULETTE_RATE);
			long Quantity = (long) (getRandom(drop[0], drop[1]) * (rate == 0 ? 1 : rate) );
			Quantity += ZeuS.getPremiumEpauletteDropRate(player, Quantity);
			st.giveItems(KE, Quantity);
