...
public final class Q10285_MeetingSirra extends Quest
{
	...
	{
		if(event.equals("FrozenCore")) {
			if(player.getInventory().getItemByItemId(15469) == null) {
				//player.getInventory().addItem("", 15469, 1, player, true);
				giveItems(player, 15469, 1);
				return "<html><font color=LEVEL>You have received Frozen Core. Good luck !</font></html>";
			}
		}
