...
public final class Klein extends AbstractNpcAI
{
	...
	private static void removeItem(L2PcInstance player)
	{
		if ((Long.parseLong(player.getVar("valakas_last_enter", "0")) + 3600000) < System.currentTimeMillis())
		{
			player.destroyItemByItemId("Valakas", STONE, 1, null, true);
		}
	}
