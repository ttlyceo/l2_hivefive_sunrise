...
public class showMyStat {
	...
	private static String getFormat(){
		...
		String Retorno = "<html><title>%CHAR_NAME%</title>" + central.LineaDivisora(2) + central.headFormat("%CHAR_NAME% 面板資訊","63AA1C") + central.LineaDivisora(2);
		Retorno += "<table border=0 width=\"280\" bgcolor=151515>" +
				"<tr><td width=140 align=CENTER>角色名稱:</td><td><font color=\"FAAC58\">%CHAR_NAME%</font></td></tr>" +
				"<tr><td width=140 align=CENTER>血盟:</td><td><font color=\"FAAC58\">%CLAN_NAME%</font></td></tr>" +
				"<tr><td width=140 align=CENTER>等級: </td><td><font color=\"FAAC58\">%CHAR_LEVEL%</font></td></tr>" +
				"<tr><td width=140 align=CENTER>主職業: </td><td><font color=\"FAAC58\">%CLASS_NAME%</font></td></tr>" +
				"<tr><td width=140 align=CENTER>目前職業: </td><td><font color=\"FAAC58\">%BASE_CLASS%</font></td></tr>" +
		...
		Retorno += central.LineaDivisora(2) +central.headFormat("PvP / Pk 資訊","DF0101") + central.LineaDivisora(2);

		Retorno += "<table border=0 width=\"280\" bgcolor=151515>" +
				"<tr>" +
				"<td width=70 align=CENTER>PvP : </td>" +
				"<td width=70 align=CENTER><font color=\"FAAC58\">%PVP_KILL%</font></td>" +
				"<td width=70 align=CENTER>PvP 狀態: </td>" +
				"<td width=70 align=CENTER><font color=\"FAAC58\">%PVP_FLAG%</font></td>" +
				"</tr>" +
				"<tr>" +
				"<td width=70 align=CENTER>PK : </td>" +
				"<td width=70 align=CENTER><font color=\"FAAC58\">%PK_KILL%</font</td>" +
				"<td width=70 align=CENTER>性向值: </td>" +
				"<td width=70 align=CENTER><font color=\"FAAC58\">%KARMA%</font></td>" +
				"</tr>" +
				"</table>";

		Retorno += central.LineaDivisora(2) + central.headFormat("配戴裝備詳情","63AA1C") + central.LineaDivisora(2);
	...
	public static void showMyStats(L2PcInstance target, L2PcInstance activeChar){
		if(!general._activated()){
			...
			if(!general.getCharConfigSHOWSTAT(target)){
					activeChar.sendMessage(target.getName() + "已將其狀態設定為不公開。");
					return;
				}
				...
				central.msgbox_Lado(activeChar.getName()+ " 正在查看你的面板.", target);
