...
public class _dress{
		...
		if(isFromCharInfo){
			if(this.isTry){
				if (idSlot == Inventory.PAPERDOLL_HAIR || idSlot == Inventory.PAPERDOLL_HAIR2) {
					if (this.ID_Deco_Try > 0) {
						return this.ID_Deco_Try;
					} else if (this.ID_Head_1 > 0) {
						return this.ID_Head_1;
					} else if (this.ID_Head_2 > 0) {
						return this.ID_Head_2;
					}
					return -100;
				}			
		...
		// if(isFullArmor()){
			// switch(idSlot){
				...
				// case Inventory.PAPERDOLL_CHEST:
		  		...
		  		// case Inventory.PAPERDOLL_HAIR:
					// return this.ID_Head_1 > 0 ? this.ID_Head_1 : -100;
				// case Inventory.PAPERDOLL_HAIR2:
					// return this.ID_Head_2 > 0 ? this.ID_Head_2 : -100;
			// }	
		// }
	...
	public void setDeco(BodyPart part, int idItem) {
		if (part == BodyPart.HEAD_1) {
			this.ID_Head_1 = idItem;
		} else if (part == BodyPart.HEAD_2) {
			this.ID_Head_2 = idItem;
		}
	}
	...
	public void setHood1(int id) {
		this.ID_Head_1 = id;
	}

	public void setHood2(int id) {
		this.ID_Head_2 = id;
	}
