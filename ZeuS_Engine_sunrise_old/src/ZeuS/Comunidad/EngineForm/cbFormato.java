...
public class cbFormato {
	...
	protected static void showItemRequestWindows(L2PcInstance player, Map<String, String> Request, String Titulo){
        ...
        "<font color=70FFB3>"+ Titulo + " 所需道具</font></td></tr></table><br>";
	    ...
	    while(itr.hasNext()){
			...
			if(ItemServerRequest.length()>0){
				...
				HTML += "<table with=270 border=0 bgcolor=1C1C1C><tr><td fixwidth=270 align= CENTER><font color=FFFABB name=hs12>沒有道具</font><br1></td></tr></table>";
			}	    	
	...
	protected static void showItemRequestWindows(L2PcInstance player, String ItemServerRequest, String ItemDonationRequest, String Titulo){
		...
		HTML += "<table width=270 background=L2UI_CT1.Windows_DF_TooltipBG><tr><td fixwidth=270 align=CENTER>" +
		"<font color=70FFB3>" + Titulo + " 所需道具</font></td></tr></table>";
		
		HTML += "<table width=270 background=L2UI_CT1.Windows_DF_TooltipBG><tr><td fixwidth=270 align=RIGHT>"+
		"<font name=hs12 color=8BECFF>伺服器道具</font></td></tr></table>";
		...
		if(ItemServerRequest.length()>0){
			...
			HTML += "<table width=270 border=0 bgcolor=1C1C1C><tr><td fixwidth=270 align=CENTER><font color=FFFABB name=hs12>沒有可顯示的道具</font><br1></td></tr></table>";
		}
		
		HTML += "<br></td></tr></table>";
		
		HTML += "<br><table width=270 background=L2UI_CT1.Windows_DF_TooltipBG><tr><td fixwidth=270 align=RIGHT><font name=hs12 color=8BECFF>捐贈道具</font></td></tr></table>";
		
		HTML += "<table width=270 background=L2UI_CT1.Windows_DF_TooltipBG><tr><td fixwidth=270>";
		
		if(ItemDonationRequest.length()==0 || ItemDonationRequest.equals("0")){
			HTML += "<table width=270 border=0 bgcolor=1C1C1C><tr><td fixwidth=270 align=CENTER><font color=FFFABB name=hs12>沒有可顯示的道具</font><br1></td></tr></table><br>";
		}else{
	...
	public static String getCostOfService(String Valores){
		String retorno = "<table width=220 cellspacing=1 cellpadding=1 bgcolor=1C1C1C><tr><td height=25><center><font color=\"339966\">服務費用</font></center></td></tr></table><br>";
		...
		if(Valores.length()>0){
			...
			for(String p1 : Valores.split(";")){
				...
				retorno += "<tr><td align=CENTER>"+ opera.getFormatNumbers(Cantidad) +" 個 " + central.getNombreITEMbyID(Integer.valueOf(Item)) + "</td></tr>"; 
			}
			retorno += "</table><br><br>";
		}
		return retorno;
